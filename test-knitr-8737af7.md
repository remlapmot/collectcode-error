...
```
     ...
     [7] "test-knitr-1.45.html"    "test-knitr-1.45.md"      "test-knitr-devel.html"  
    [10] "test-knitr-devel.md"     "test.Rmd"               
...
```
    ...
    -rw-r--r--  1 tom  staff  53 Nov  7 10:08 profile.do
...
```
    ...
    Package version:
      ...
      knitr_1.44.2    methods_4.3.2   stats_4.3.2     tools_4.3.2    
